...
export const AppContextProvider: FC<AppContextProps> = ({ children }) => {
    ...
    const getAllImages = async () => {
        try {
            ...
            const response = await axios.get("https://server-kappa-bay-55.vercel.app/api/allImages")
    ...
    const handleTitleUpdate = async () => {
        try {
            ...
            await axios.put(`https://server-kappa-bay-55.vercel.app/api/image/${selectedImageId}`, payload)
    ...
    const handleImageDelete = async () => {
        try {
            ...
            await axios.delete(`https://server-kappa-bay-55.vercel.app/api/image/${selectedImageId}`)
