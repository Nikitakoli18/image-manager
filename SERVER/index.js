...
app.use(morgan("dev"));
app.use(cors({
  origin: ["https://image-manager-psi.vercel.app", "http://localhost:5173"],
...
const options = {
    definition: {
        ...
        servers: [
            {
                url: "https://server-kappa-bay-55.vercel.app",
...
app.get("/", (req, res) => {
    res.send(`<a href="https://server-kappa-bay-55.vercel.app/api-docs/">Swagger Documentation</a>`)
});
